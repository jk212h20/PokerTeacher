...
const P_TRANSLATIONS = {
  en: {
    ...
    'rb.q.playing_the_board': 'Does the board itself make a strong hand?',
    ...
    'rb.e.playing_the_board_yes': 'The board makes a <strong>{0}</strong>: {1}. Anyone at the table has at least this hand.',
    'rb.e.playing_the_board_no': 'The board is just high cards / a pair — no complete strong hand (straight, flush, full house+).',
  ...
  es: {
    ...
    'rb.q.playing_the_board': '¿El tablero forma una mano fuerte?',
    ...
    'rb.e.playing_the_board_yes': 'El tablero forma un <strong>{0}</strong>: {1}. Cualquier jugador tiene al menos esta mano.',
    'rb.e.playing_the_board_no': 'El tablero es solo cartas altas / una pareja — no forma una mano fuerte (escalera, color, full house+).',
